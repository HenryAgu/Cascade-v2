    ...
    <section className="py-5 lg:py-20 lg:pb-32 w-full container mx-auto px-5 lg:px-20">
      <div className="flex flex-col gap-y-24">
        <div className="flex flex-col gap-y-3.5 items-end justify-center">
          <h3 className="text-3xl  font-source font-medium text-black">
            Who We Are
          </h3>
          <p className="max-w-[520px] font-source text-lg text-black2 font-normal">
        ...
        <div className="flex flex-col gap-y-3.5 items-end justify-center">
          ...
          <span className=" font-source text-xl text-black2 font-normal">
            At Cascade, we are guided by:
          </span>
          <ul className="flex flex-col gap-y-2 list-disc">
            {coreValues.map((item, index) => (
              <li
                className="max-w-[520px] font-source text-lg text-black2 font-normal"
                key={index}
              >
