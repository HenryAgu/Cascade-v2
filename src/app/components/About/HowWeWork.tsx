  ...
  return (
    <section className="w-full container mx-auto px-5 lg:px-32 py-14 lg:py-32 bg-brand-darkblue">
      <div className="flex flex-col gap-y-5">
        <Image src="/images/image.svg" height={40} width={40} alt="image_icon"/>
        <span className="text-white font-source text-base lg:text-lg font-semibold">
          What You Get With CASCADE
        </span>
        <p className="text-white font-source text-2xl leading-8 lg:leading-10 lg:text-[32px] font-normal">
