...
const HomeAboutSection = () => {
  ...
  return (
    <section className="py-10 lg:py-20 pb-20 bg-brand-lightblue px-5 lg:px-20">
      <div className="">
      ...
      <div className="w-full flex lg:flex-row flex-col gap-y-5 gap-x-3.5 pt-10 lg:pt-20">
        ...
        <div className="basis-[80%] flex gap-x-8 w-full">
          ...
          <div className="basis-[40%] lg:basis-[30%] flex flex-col gap-y-8">
            <h3
              className={`${playfairDisplay.className} font-jarkata text-white text-[61px] leading-[60px]`}
            >
              Student <br /> Access
            </h3>
