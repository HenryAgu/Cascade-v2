    ...
    <section className="flex lg:flex-row flex-col items-center gap-10 py-5 lg:py-10 lg:pb-20 font-source w-full container mx-auto px-5 lg:px-20">
      <div className="basis-full lg:basis-[50%] flex flex-col lg:text-left text-center gap-y-5 w-full">
        ...
        <div className="flex md:flex-row flex-col items-center gap-5 w-full lg:mt-5">
          <Link
            href=""
            className="text-base font-source font-medium border-[1.5px] border-brand-blue py-3 px-6 rounded-sm text-white bg-brand-blue capitalize"
          >
            Get your school involved
          </Link>
          <Link
            href=""
            className="text-base font-source font-medium border-[1.5px] border-brand-blue text-brand-blue bg-white py-3 px-6 rounded-sm capitalize"
          >
            Get to know us
          </Link>
        </div>
